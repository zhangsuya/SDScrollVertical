...
@interface SYVerticalPageControl()
...
@end
@implementation SYVerticalPageControl
...
- (void)updateDotFrame:(UIView *)dot atIndex:(NSInteger)index
{
    ...
    CGFloat x = (CGRectGetHeight(self.frame) - self.dotSize.width) / 2;
    CGFloat y = (self.dotSize.height + self.spacingBetweenDots) * index + ( (CGRectGetWidth(self.frame) - [self sizeForNumberOfPages:self.numberOfPages].height) / 2);
